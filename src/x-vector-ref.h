...
#define VECTOR_REF_DERIVE_ALLOC(INNER_TYPE) Vector$##INNER_TYPE* vector$ref$##INNER_TYPE##_alloc(){\
    int capacity=0;\
...
#define VECTOR_REF_DERIVE_INIT(INNER_TYPE) Vector$##INNER_TYPE* vector$ref$##INNER_TYPE##_init(\
...
#define VECTOR_REF_DERIVE_FREE(INNER_TYPE) Vector$##INNER_TYPE* vector$ref$##INNER_TYPE##_free(\
...
#define VECTOR_REF_DERIVE_PRINT(INNER_TYPE,RESULT_EXPANSION) int vector$##INNER_TYPE##_print(\
    Vector$##INNER_TYPE* self\
){\
...
#define VECTOR_REF_DERIVE_PUSH(INNER_TYPE) Vector$##INNER_TYPE* vector$ref$##INNER_TYPE##_push(\
...
#define VECTOR_REF_DERIVE_COPY(INNER_TYPE) Vector$##INNER_TYPE vector$ref$##INNER_TYPE##_copy(\
    Vector$##INNER_TYPE* self\
){\
...
#define VECTOR_REF_DERIVE_CONCAT(INNER_TYPE) Vector$##INNER_TYPE vector$##INNER_TYPE##_concat(\
    Vector$##INNER_TYPE* self,\
    ...
    vector$ref$##INNER_TYPE##_free(self);\
    vector$ref$##INNER_TYPE##_free(other);\
    return copy;\
}
